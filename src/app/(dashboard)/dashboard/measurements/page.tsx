...
export default async function MeasurementsPage({
  ...
  const page = Math.min(query.pageRequested, Math.max(1, totalPages));
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-fg">Measurements</h1>
        <p className="mt-0.5 max-w-3xl text-sm text-muted">
          Charts and readings for your pool monitors
        </p>
